...
class OHealthMedicationTemplate(osv.Model):
    _name = 'ohealth.medication.template'
    ...
    _columns = {
        'medicament_id': fields.many2one('ohealth.medicament', string='Medicament', requered=True, help='Product Name', ondelete='cascade'),
        ...
        'route': fields.many2one('ohealth.drug.route', string='Administration Route', help='Drug administration route code.'),
        ...
        'common_dosage': fields.many2one('ohealth.medication.dosage', string='Frequency', help='Common / standard dosage frequency for this medicament'),
