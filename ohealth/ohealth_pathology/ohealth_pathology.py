...
class OHealthPathology(osv.Model):
    _name = 'ohealth.pathology'

    _columns = {
        'category': fields.many2one('ohealth.pathology.category', string='Main Category', 
        ...
        'groups': fields.one2many('ohealth.disease_group.members', 'disease_group_id', string='Groups',
