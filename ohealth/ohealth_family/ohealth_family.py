...
class OHealthFamily(osv.Model):
    _name = 'ohealth.family'

    _columns = {
        'info': fields.text(string='Extra Information'),
        'operational_sector': fields.many2one('ohealth.operational_sector',
        ...
        'members': fields.one2many('ohealth.family_member', 'family_id',
