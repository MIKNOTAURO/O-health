...
class OHealthPatientMedication(osv.Model):
    _name = 'ohealth.patient.medication'

    _columns = {
        'patient_id': fields.many2one('ohealth.patient', string='Patient',),
#        'name': fields.many2one('ohealth.patient', string='Patient',
#                                readonly=True ),
        'doctor': fields.many2one('ohealth.physician', string='Physician', 
        ...
        'template': fields.many2one('ohealth.medication.template',
