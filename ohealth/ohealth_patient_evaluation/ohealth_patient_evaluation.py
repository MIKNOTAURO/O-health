...
class OHealthPatientEvaluation(osv.Model):
    _name='ohealth.patient.evaluation'
    _rec_name='patient_id'
    _columns={
        'patient_id':fields.many2one('ohealth.patient', 'Patient'),
        ...
        'actions': fields.one2many('ohealth.directions',
        ...
        'evaluation_date': fields.many2one('ohealth.appointment',
                                           string='Appointment',
        ...
        'doctor': fields.many2one('ohealth.physician', string='Doctor',
                                  readonly=True),
        'knowledge_current_events': fields.boolean(
            ...
            ' notorious events'),
        'next_evaluation': fields.many2one('ohealth.appointment',
                                           string='Next Appointment',),
        'signs_and_symptoms': fields.one2many('ohealth.signs_and_symptoms',
                                              'evaluation_id',
        ...
        'abstraction': fields.boolean(string='Abstraction',
            ...
            ' abstract reasoning'),
        'patient_id': fields.many2one('ohealth.patient', string='Patient',),
        'derived_from': fields.many2one('ohealth.physician',
                                        string='Derived from',
                                        help='Physician who derived the case'),
        'specialty': fields.many2one('ohealth.specialty',
                                     string='Specialty',),
        ...
        'derived_to': fields.many2one('ohealth.physician',
                                      string='Derived to',
        ...
        'secondary_conditions': fields.one2many(
            'ohealth.secondary_condition', 'evaluation_id',
        ...
        'diagnosis': fields.many2one('ohealth.pathology',
