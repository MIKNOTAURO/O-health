...
class DrugsRecreational(osv.Model):
    ...
    _name = 'ohealth.drugs_recreational'
...
class PatientRecreationalDrugs(osv.Model):
    ...
    _name = 'ohealth.patient.recreational_drugs'
    _description = 'Patient use of Recreational Drugs'

    _columns = {
            'patient_id' : fields.many2one('ohealth.patient', 'Patient'),
            'recreational_drug' : fields.many2one('ohealth.drugs_recreational', 'Recreational Drug'),
                }
...
class PatientCAGE(osv.Model):
    ...
    _name = 'ohealth.patient.cage'
    _description =  'Patient CAGE Questionnaire'
    _columns = {

    'name' : fields.many2one('ohealth.patient', 'Patient', required=True),
...
class MedicalPatient(osv.Model):
    ...
    'recreational_drugs' : fields.one2many( 'ohealth.patient.recreational_drugs', 'patient_id', 'Drugs'),
    ...
    'cage' : fields.one2many('ohealth.patient.cage', 'name', 'CAGE'),
            }
