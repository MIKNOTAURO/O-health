...
class OHealthPatientDisease(osv.Model):
    _name = 'ohealth.patient.disease'

    _columns = {
        'treatment_description': fields.char(size=256,
                                             string='Treatment Description'),
        'healed_date': fields.date(string='Healed'),
        'pathology': fields.many2one('ohealth.pathology',
        ...
        'pcs_code': fields.many2one('ohealth.procedure', string='Code', 
